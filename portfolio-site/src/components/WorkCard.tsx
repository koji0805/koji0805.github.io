...
export function WorkCard({ portfolio, index }: WorkCardProps) {
  ...
  // 修正: 正しいプロパティ名を使用
  const tags = portfolio.technologies || []      // technologies を使用
  const imageUrl = portfolio.thumbnail           // thumbnail を使用
  const githubUrl = portfolio.github_url         // github_url を使用
    ...
    >
      <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="p-6">
          ...
          {githubUrl && (                         // 修正: githubUrl を使用
            <div className="flex justify-end">
              <a
                href={githubUrl}                   // 修正: githubUrl を使用
                target="_blank"
